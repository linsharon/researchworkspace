...
export function LiteratureNoteForm({ initialValue, onSubmit }: LiteratureNoteFormProps) {
  ...
  return (
    <Card className="overflow-hidden border-slate-200 bg-slate-50/80 shadow-sm backdrop-blur-sm">
      <div className="flex">
        <div className="flex w-14 shrink-0 items-center justify-center border-r border-slate-200 bg-gradient-to-b from-slate-200 to-slate-100">
          <Quote className="h-5 w-5 text-slate-600" />
        </div>

        <div className="flex-1">
          <CardHeader className="pb-4">
            <CardTitle className="text-slate-900">Literature Note</CardTitle>
