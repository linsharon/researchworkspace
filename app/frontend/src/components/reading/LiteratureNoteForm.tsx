...
export function LiteratureNoteForm({ initialValue, paper, onSubmit }: LiteratureNoteFormProps) {
  ...
  const validate = (value: LiteratureNote) => {
    ...
    if (!value.title.trim()) {
      nextErrors.title = isZh ? "标题是必须的（作者-年份）。" : isZh ? "标题是必须的（作者-年份）。" : isZh ? "标题是必须的（作者-年份）。" : "Title is required (Author-Year).";
    }
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Input
                    id="lit-title"
                    placeholder={isZh ? "例如，Smith-2021" : isZh ? "例如，Smith-2021" : isZh ? "例如，Smith-2021" : "e.g., Smith-2021"}
                    value={form.title}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="lit-page"
                    placeholder={isZh ? "例如，42" : isZh ? "例如，42" : isZh ? "例如，42" : "e.g., 42"}
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <NoteTagInput
                    ...
                    placeholder={isZh ? "输入关键词并按回车" : isZh ? "输入关键词后按回车键" : isZh ? "输入关键词后按回车键" : "Type keyword and press Enter"}
                    tags={form.keywords}
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="lit-gist"
                  rows={4}
                  placeholder={isZh ? "用自己的话总结这段文字为何重要。" : isZh ? "用自己的话总结这段文字为何重要。" : isZh ? "用自己的话总结这段文字为何重要。" : "Summarize why this passage matters in your own words."}
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="lit-quote"
                  rows={5}
                  placeholder={isZh ? "粘贴来自源的准确引用。" : isZh ? "粘贴来自源的准确引用。" : isZh ? "粘贴来自源的准确引用。" : "Paste exact quotation from the source."}
