...
export const DUMMY_PROJECTS: ProjectItem[] = [
  ...
  },
  {
    ...
    goal: "Investigate the effectiveness of carbon pricing policies across different economic contexts",
    currentStep: 4,
    updatedAt: "2026-03-07",
  },
  {
    ...
    goal: "Explore the relationship between remote work arrangements and employee mental health outcomes",
    currentStep: 1,
