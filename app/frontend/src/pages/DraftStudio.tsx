        ...
        <div className="w-72 border-r border-slate-700/50 bg-slate-800/30 shrink-0 flex flex-col">
          <div className="p-4 border-b border-slate-700/50 space-y-2">
            ...
            <Select value={projectId} onValueChange={setProjectId}>
              <SelectTrigger>
                <SelectValue placeholder={isZh ? "选择项目" : isZh ? "选择项目" : isZh ? "选择项目" : "Select project"} />
              </SelectTrigger>
              <SelectContent>
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex-1 p-6 overflow-auto space-y-4">
            ...
            <Textarea
              ...
              placeholder={isZh ? "开始撰写您的草稿。从左侧面板插入笔记或概念..." : isZh ? "开始撰写您的草稿。从左侧面板插入笔记或概念..." : isZh ? "开始撰写您的草稿。从左侧面板插入笔记或概念..." : "Start writing your draft. Insert notes or concepts from the left panel..."}
            />
          </div>
