...
export default function DraftStudio() {
        ...
        <div className="space-y-3">
          <div className="p-3 bg-white border border-slate-200 rounded-lg">
            ...
            <div className="space-y-1.5 text-xs">
              <div className="flex items-center gap-2">
                ...
                <span className="text-slate-700">Introduction present</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-500 shrink-0" />
                <span className="text-slate-700">Research question stated</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-500 shrink-0" />
                <span className="text-slate-700">Significance section</span>
              </div>
              <div className="flex items-center gap-2">
                <Circle className="w-3.5 h-3.5 text-amber-400 shrink-0" />
                <span className="text-slate-400">Literature review section needed</span>
              </div>
              <div className="flex items-center gap-2">
                <Circle className="w-3.5 h-3.5 text-slate-300 shrink-0" />
                <span className="text-slate-400">Methodology section needed</span>
              </div>
            </div>
          </div>
          ...
          <div className="p-3 bg-white border border-slate-200 rounded-lg">
            ...
            <div className="space-y-1.5 text-xs">
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-500 shrink-0" />
                <span className="text-slate-700">Gap identified clearly</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-500 shrink-0" />
                <span className="text-slate-700">Theoretical framing present</span>
              </div>
              <div className="flex items-center gap-2">
                <Circle className="w-3.5 h-3.5 text-amber-400 shrink-0" />
                <span className="text-slate-400">Argument flow needs strengthening</span>
              </div>
            </div>
          </div>
          ...
          <div className="p-3 bg-white border border-slate-200 rounded-lg">
            ...
            <div className="space-y-1.5 text-xs">
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-500 shrink-0" />
                <span className="text-slate-700">Citations included (4)</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-500 shrink-0" />
                <span className="text-slate-700">Academic tone maintained</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-3.5 h-3.5 text-emerald-500 shrink-0" />
                <span className="text-slate-700">Key terms defined</span>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <AppLayout rightPanelContent={rightPanelContent}>
