  ...
  const handleAddToMyPackages = (pkg: ArtifactPackage) => {
    ...
    try {
      ...
      if (alreadyDownloaded) {
        toast.info(tr("Already in your downloaded packages", "已在你的已下载产集中"));
        return;
      }
      ...
      toast.error(tr("Failed to add package", "添加产集失败"));
    }
  };
      ...
      <div className="p-6 max-w-5xl mx-auto space-y-5 text-slate-100">
        <div className="flex items-center justify-between">
          ...
          <Badge variant="outline" className="text-xs">
            {filteredPackages.length} {tr("packages", "产集")}
          </Badge>
        </div>
        ...
        <div className="relative max-w-md">
          ...
          <Input
            ...
            placeholder={tr("Search packages, artifacts, categories...", "搜索产集、产件、类别...")}
              ...
              >
                <CardHeader className="pb-2">
                  ...
                  <p className="text-[11px] text-slate-500">
                    {pkg.artifacts.length} {tr("artifacts", "产件")} · {pkg.createdAt} · {pkg.downloadCount || 0} {tr("downloads", "下载次数")}
                  </p>
                </CardHeader>
                <CardContent className="space-y-3">
                  ...
                  <div className="flex gap-1.5 pt-1">
                    ...
                    >
                      ...
                      {tr("Add to My Packages", "添加到我的产集中")}
                    </Button>
                  </div>
                </CardContent>
              </Card>
          ...
          <AlertDialogContent className="glass-panel border-0 text-slate-100">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="text-slate-300">
                {tr("Free accounts can add at most 2 packages from Community Packages to My Packages. Upgrade to Premium to add more packages and unlock Team features.", "免费账户最多可以将2个社区产集添加到我的产集中。升级为高级版可以添加更多产集并解锁团队功能。")}
              </AlertDialogDescription>
            </AlertDialogHeader>
